/*
 * Configuracion de entradas y salidas para EchidnaBlack2C
 */
...
#define LDR A3     //Entrada analógica conectada a la LDR

#define Temp A6    //Entrada analógica conectada al sensor de temperatura

#define Mic A7    //Entrada analógica conectada al microfóno
